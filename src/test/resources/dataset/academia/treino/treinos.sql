...
INSERT INTO treino(
    ...
    VALUES (1000, now(), null, '2018-10-31', '2018-08-01', '22:00:00', 
            '23:00:00', 'Treino de teste', 1011, 1012);
     
INSERT INTO treino(
            id, created, updated, data_fim, data_inicio, hora_prevista_inicio, 
            hora_prevista_termino, nome, aluno_id, personal_id)
    VALUES (1001, now(), null, '2018-10-31', '2018-08-01', now(), 
            '23:00:00', 'Treino de teste', 1011, 1012);
            
INSERT INTO treino(
            id, created, updated, data_fim, data_inicio, hora_prevista_inicio, 
            hora_prevista_termino, nome, aluno_id, personal_id)
    VALUES (1001, now(), null, '2018-10-31', '2018-09-01', now(), 
            now(), 'Treino de teste', 1011, 1012);
