...
INSERT INTO pessoa_notificacao(
            id, created, updated, is_destinatario, notificacao_id, pessoa_id)
    VALUES (1000, NOW(), null, false, 1002, 1012);

INSERT INTO pessoa_notificacao(
            id, created, updated, is_destinatario, notificacao_id, pessoa_id)
    VALUES (1001, NOW(), null, true, 1002, 1011);
